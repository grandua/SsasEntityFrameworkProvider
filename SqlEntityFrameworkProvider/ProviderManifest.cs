...
namespace SqlEntityFrameworkProvider
{
    ...
    internal class SqlProviderManifest : DbXmlEnabledProviderManifest
    {
        ...
        private StoreVersion _version = StoreVersion.Sql10;
        private string _token = TokenSql10;
        ...
        {
            return GetXmlResource("SqlEntityFrameworkProvider.Resources.SqlProviderServices.ProviderManifest.xml");
        }
        
        private XmlReader GetStoreSchemaMapping()
        {
            return GetXmlResource("SqlEntityFrameworkProvider.Resources.SqlProviderServices.StoreSchemaMapping.msl");
        }

        private XmlReader GetStoreSchemaDescription()
        {
            return GetXmlResource(
"SqlEntityFrameworkProvider.Resources.SqlProviderServices.StoreSchemaDefinition.ssdl");
        }
                ...
                case PrimitiveTypeKind.Decimal: // decimal, numeric, smallmoney, money
                    {
                        ...
                        return TypeUsage.CreateDecimalTypeUsage(StoreTypeNameToStorePrimitiveType["decimal"], precision, scale); //"extDecimal" originally
                    }
